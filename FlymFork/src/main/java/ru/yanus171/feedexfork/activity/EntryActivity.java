        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (entryUri == null) {
                    ...
                    FetcherService.LoadLink(feedID, url, title, null, FetcherService.ForceReload.Yes, true, true, false, FetcherService.AutoDownloadEntryImages.No, false, true, false);
                } else {
                    SetEntryID(entryUri, url);
                }
                RestartLoadersOnGUI();
